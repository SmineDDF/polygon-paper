...
class ContextMenu extends paper.Group {
    private menuItems: Array<ContextMenuItem>;
    ...
    private getRelevantMenuItems(point: paper.Point, hitResult: paper.HitResult): Array<ContextMenuItem> {
        return getRelevantMenuItemsDeclarations(hitResult).map(decl => ContextMenuItem.fromDeclaration(decl, { hitResult, point }));
    }

    private renderMenu(items: Array<ContextMenuItem>) {
