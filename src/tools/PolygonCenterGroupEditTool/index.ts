...
import type { DraggableCenterPoint } from '../../DraggableCenterPoint';

import type { IAttachedTool, Tool } from '../Tool';
...
class PolygonCenterGroupEditTool implements IAttachedTool {
    ...
    private onMouseUpHandler = () => {
        ...
        if (this.currentlyDraggedCenterPoint) {
            this.currentlyDraggedCenterPoint.registerCenterDragEnd();
        }
    };
